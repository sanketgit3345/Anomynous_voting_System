        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="sm:flex sm:items-baseline">
              ...
              <div className="mt-4 sm:mt-0">
                <nav className="-mb-px flex space-x-8">
                  ...
                  <a href="/my-polls" className="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">
                    My Polls
                  </a>
                </nav>
              </div>
          ...
          <div className="mb-6 md:flex md:items-center md:justify-between">
            <div className="flex-1 min-w-0">
              <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:tracking-tight">Voting Dashboard</h2>
              <p className="mt-1 text-sm text-gray-500">Create and manage secure polls with anonymous voting.</p>
            </div>
            ...
            {pollsLoading ? (
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <a href="/create-poll" className="mt-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
